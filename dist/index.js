    ...
    class FlightSchedule {
        ...
        this.filters.forEach((filter) => {
          ...
          if (input) {
            input.addEventListener("change", (e) => {
              ...
              const selectedFilter = selectedParent.querySelector("span")?.textContent;
              `  `;
              this.filters.forEach((filter2) => {
                const filterInput = filter2.querySelector("input");
                if (filterInput) {
                  filterInput.checked = false;
                  const filterLabel = filter2.children[0];
                  filterLabel.style.color = "#000510";
                  const filterUI = filter2.querySelector(".w-checkbox-input");
      ...
      applyFilter(filterKey) {
        ...
        if (filterKey === "Public Flights") {
          ...
          filteredData = this.parsedFlightData;
        }
      ...
      createRow(flight) {
        ...
        const buttonElement = row.querySelector(".sl_button-wrap");
        if (locationElement)
