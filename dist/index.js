...
(() => {
  ...
  var init_live_reload = __esm({
    "bin/live-reload.js"() {
      ...
      if (window.location.hostname === "localhost") {
        new EventSource(`http://localhost:${3e3}`).addEventListener(
          "change",
          () => location.reload()
        );
      }
    ...
    "src/components/global/nav.ts"() {
      ...
      nav = () => {
        class Nav {
          ...
          animateNavBgIn() {
            gsapWithCSS.to(this.navBg, { y: "0%", duration: 1, ease: this.easeFloat });
          }
          animateNavBgOut() {
            gsapWithCSS.to(this.navBg, { y: "-100%", duration: 1, ease: this.easeFloat });
          }
        }
        new Nav();
      };
    ...
    "src/components/global/hubspotForm.ts"() {
      ...
      hubspotForm = () => {
        class HubSpotFormHandler {
          ...
          validateHoney() {
            const emailConf = document.querySelector("input[name='Email-Confirm']")?.value || "";
          ...
          showSuccessMessage() {
            ...
            gsapWithCSS.to(error, { opacity: 0, duration: 0.5 });
          ...
          showErrorMessage(text) {
            const formParent = this.form.parentElement;
            const errorContainer = formParent.querySelector(".hs-form_error");
    ...
    "src/utils/revealVideos.ts"() {
      ...
      revealVideo = () => {
        class RevealVideo {
          ...
          scrollTrigger;
          constructor() {
            this.triggerElement = document.querySelector("[data-overview-component]");
            this.videoElements = [...this.triggerElement.querySelectorAll("video")].map(
              (item) => item
            );
            if (this.videoElements === null)
              return;
  ...
  // src/components/global/popupModal.ts
  var popupModal_exports = {};
  __export(popupModal_exports, {
    default: () => popupModal_default,
    popupModal: () => popupModal
  });
  var popupModal, popupModal_default;
    ...
    "src/components/global/popupModal.ts"() {
      ...
      popupModal = () => {
        class FlashSalePopup {
          ...
          flashItems;
          constructor() {
            this.flashSaleBanner = document.querySelector(".section_flash-sale");
            this.popup = document.querySelector(".section_popup");
            this.flashTrack = document.querySelector(".flash_track");
          ...
          openPopup() {
            if (!this.isOpen) {
              gsapWithCSS.set(this.popup, { display: "flex", opacity: 0 });
              gsapWithCSS.to(this.popup, { opacity: 1, y: 0, duration: 0.5, ease: "power3.out" });
              this.isOpen = true;
            }
          }
          closePopup() {
            if (this.isOpen) {
              gsapWithCSS.to(this.popup, { opacity: 0, y: -50, duration: 0.5, ease: "power3.in" });
              gsapWithCSS.set(this.popup, { display: "none" });
              this.isOpen = false;
            }
          }
          animateBanner() {
  ...
  var cookieConsent_exports = {};
  __export(cookieConsent_exports, {
    cookieConsent: () => cookieConsent,
    default: () => cookieConsent_default
  });
  var cookieConsent, cookieConsent_default;
  var init_cookieConsent = __esm({
    "src/utils/cookieConsent.ts"() {
      "use strict";
      init_live_reload();
      init_gsap();
      cookieConsent = () => {
        class CookieConsent {
          ...
          constructor() {
            this.component = document.querySelector(".cookies_component");
            this.accept = document.querySelector("#cookieAccept");
            this.decline = document.querySelector("#cookieDecline");
            this.init();
          }
          init() {
            if (!this.component)
      ...
      `;
          ...
          disableTracking() {
            ...
            document.cookie.split(";").forEach((cookie) => {
              document.cookie = cookie.replace(/^ +/, "").replace(/=.*/, "=;expires=" + (/* @__PURE__ */ new Date(0)).toUTCString() + ";path=/");
            });
          }
          revealConsent() {
      ...
      cookieConsent_default = cookieConsent;
    }
  });
  ...
  window.Webflow ||= [];
  window.Webflow.push(() => {
    console.log("\u{1F310} Zero-G \u{1F310}");
    ...
    initComponent(".hs-form_main", () => Promise.resolve().then(() => (init_hubspotForm(), hubspotForm_exports)));
    ...
    initComponent(".section_flash-sale", () => Promise.resolve().then(() => (init_popupModal(), popupModal_exports)));
    initComponent(".news-form_component", () => Promise.resolve().then(() => (init_newsletter(), newsletter_exports)));
    initComponent(".cookies_component", () => Promise.resolve().then(() => (init_cookieConsent(), cookieConsent_exports)));
