...
(() => {
    ...
    "src/components/global/faq.ts"() {
      ...
      faq = () => {
        ...
        class FAQ {
          ...
          faqItems;
          constructor() {
            this.faqList = document.querySelector(".faq_list");
            this.faqItems = this.faqList.querySelectorAll(".faq_item");
            this.init();
          }
          init() {
      ...
      imageSlider = () => {
        ...
        class ImageSlider {
          ...
          constructor() {
            ...
            this.totalWidth = 0;
            this.slideDuration = parseInt(this.imagesContainer.dataset.slideSpeed) * 10;
          ...
          initAnimation() {
            const duration = this.totalWidth / 100;
            ...
            this.tl.to(this.imagesContainer, {
              ...
              // Move left until the last image is at the edge
              ease: "linear",
              duration
            });
          }
    ...
    "src/components/global/hubspotForm.ts"() {
      ...
      hubspotForm = () => {
        ...
        class HubSpotFormHandler {
          ...
          constructor() {
            this.form = document.querySelector("#hs-form");
            this.bindEvents();
          }
          bindEvents() {
            if (this.form) {
  ...
  // src/components/global/pricing.ts
  var pricing_exports = {};
        ...
        class Pricing {
          ...
          setTags() {
            this.pricingTags.forEach((item) => {
              const itemGlyph = item.querySelector(".glyph_square");
              const itemText = item.querySelector(".text-size-small");
          ...
          initializeEvents() {
            this.mediaItems.forEach((item) => {
              ...
              item.addEventListener("click", (item2) => {
                const clicked = item2.target;
                const clickedSrc = clicked.src;
                video.pause();
                if (clickedSrc) {
                  if (this.modal)
                    this.modalVideo.src = clickedSrc;
                }
                this.showModal();
              });
    ...
    class FlightSchedule {
      ...
      parseData(data) {
        const flightArray = data.map((item) => {
          ...
          let link = "#";
          if (location2 !== "") {
            link = this.formatRowLink(location2);
          } else {
      ...
      openModal() {
        const modal = document.querySelector(".section_rez");
        if (modal) {
          gsapWithCSS.set(modal, { display: "flex" });
          gsapWithCSS.fromTo(modal, { opacity: 0, scale: 0.8 }, { opacity: 1, scale: 1 });
        }
      }
      ...
      closeModal() {
        ...
        if (modal) {
          gsapWithCSS.to(modal, {
            ...
            duration: 0.5,
            onComplete: () => {
              gsapWithCSS.set(modal, { display: "none" });
            }
          });
        }
      }
  ...
  window.Webflow.push(() => {
    ...
    initComponent(".section_pricing", () => Promise.resolve().then(() => (init_pricing(), pricing_exports)));
